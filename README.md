[![Run App](https://github.com/WBryant05/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/WBryant05/GithubActions/actions/workflows/run-app.yaml)
